...
export default function DataSummary() {
  ...
  const growthRecords = currentBabyId ? getBabyGrowth(currentBabyId) : [];
  const latest = currentBabyId ? getLatestGrowth(currentBabyId) : null;

  const chartData = growthRecords.map((r) => ({
